package com.newbee.material.repo.interceptor;
...
public class AuthorizedInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (!shouldIgnore(servletPath)) {
			...
			if (user == null) {
				...
				request.getRequestDispatcher(Constants.LOGIN).forward(request,
						response);
				return false;
			} else {
				return true;
	...
	private boolean shouldIgnore(String servletPath) {
